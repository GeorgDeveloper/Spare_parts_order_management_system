...
*****************************************************************************
Окно заказа:
1)	Заказчик создает заявки с понятным обоснованием содержащим:
А) При заказе запасной части:
- наименование станка
- наименование узла
- количество данного изделия (детали) установленного на оборудовании
- проверять и указывать текущее наличие на складе
- при стоимости изделия свыше 100 000 руб обязательно прикладывать  ТЗ на 
ремонт имеющихся образцов с указанием количества нуждающихся в ремонте деталей
 и стоимостью ремонта.
Б) При заказе инструмента и расходных материалов:
- имеющееся количество
- ресурс изделия и дату последнего заказа
- прикладывать ведомость выдачи во временное пользование в PDF
- для специнструмента или уникальных материалов – указывать станок, узел, или
 место конкретного использования

 в поле "Загрузки" необходимо прикреплять шильд изделия либо интернет ссылку 
на заказываемое изделие, для запасных частей его заполнение обязательно

 поле "Полное описание материала" не является обязательнымв нем указываются 
характеристики заказываемого объекта для  более быстрой и точной обработки 
отделом ОМТС
